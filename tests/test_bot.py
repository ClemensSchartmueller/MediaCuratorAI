...
class TestSignalBot(unittest.TestCase):
    ...
    def test_handle_reply_movie(
        self, mock_requests, MockDB, MockRadarr, MockSonarr, MockGemini
    ):
        ...
        mock_model_response.text = (
            '[{"tmdb_id": 4, "title": "New Movie", "type": "movie"}]'
        )
        ...
        bot._get_active_recs_summary = MagicMock(
            return_value="1. New Movie (TMDB: 4, Type: movie)"
        )
